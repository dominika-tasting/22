...
# Объявляем функцию для определения цифр в строке
...
# Проверяем соответствие, указанное в условии ввода данных
...
# Производим установку позиции элемента
...
# Производим установку номера позиции элемента,
# который меньше введенного пользователем числа, и следующего за ним, который больше или равен этому числу
